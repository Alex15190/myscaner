...
enum Lexem_code : unsigned short {
    ...
    Kw_float,                Kw_print,             Kw_float32,           
    Kw_float64,              Kw_float80,           Kw_float128,          
    Kw_return,               Kw_endif,             Kw_for,               
    ...
    Kw_var,                  Kw_export,            Kw_enum,              
    Kw_repeat,               Kw_while,             Kw_continue,          
    Kw_match,                Kw_char,              Kw_char8,             
    Kw_char16,               Kw_char32,            Kw_ref,               
    Kw_string,               Kw_string8,           Kw_string16,          
    Kw_string32,             Kw_struct,            Kw_type,              
    Kw_then,                 Kw_short,             Kw_int,               
    Kw_int8,                 Kw_uint,              Kw_int16,             
    Kw_int32,                Kw_int64,             Kw_fn,                
    Kw_until,                Kw_break,             Kw_int128,            
    Comma,                   Semicolon,            Colon,                
    Dot,                     Open_round_bracket,   Closed_round_bracket, 
    Open_square_bracket,     Closed_square_bracket,At_sign,              
    Tuple_begin,             Tuple_end,            Conditional_op,       
